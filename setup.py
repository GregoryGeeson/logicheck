#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe Logicheck.py -c -b 3 -W setup.py
...
Logicheck = Target(
    ...
    script="Logicheck.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'Logicheck'
    # dest_base = "Logicheck",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"Logicheck.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="Logicheck", level="asInvoker")).encode("utf-8")),
